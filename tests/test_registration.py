...
def test_successful_registration(chromium_page: Page):
    print("This test simulates a successful user registration process.")
    ...
    password_input = chromium_page.get_by_test_id(
        "registration-form-password-input"
    ).locator("input")
    password_input.fill("password")

    registration_button = chromium_page.get_by_test_id(
    ...
    ), "Dashboard page title should be visible after successful registration"
