...
with sync_playwright() as playwright:
    ...
    empty_list_title_text = page.get_by_test_id("courses-list-empty-view-title-text")
    expect(empty_list_title_text).to_be_visible()
    expect(empty_list_title_text).to_have_text("There is no results")
